...
emerge --quiet @vonfry-00-portage
layman-updater -R
layman -S

# system basic tools
emerge --quiet @vonfry-10-system
...
# editor
emerge --quiet @vonfry-30-editor

# development
layman -a haskell
emerge --quiet @vonfry-40-lang
emerge --quiet @vonfry-41-db
emerge --quiet @vonfry-42-misc
